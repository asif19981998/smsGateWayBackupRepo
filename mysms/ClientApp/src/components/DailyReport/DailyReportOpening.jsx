...
export default function DailyReportOpening() {
    ...
    var seletedRows = [];
    var report_date_and_title = `Daily Opening Report(Start Watching)_${reportDate}`
    const url = "api/DailyReport/getOpeningReport";
    var today = new Date();
    ...
    const [columns, setColumns] = useState([
        ...
        { title: 'Arc Start Time', field: 'arcStopTime', editable: 'never' },
        { title: 'SMS', field: 'sms', editable: 'never', editable: 'onUpdate' },
        { title: 'Sms Start Time', field: 'smsStopTime', editable: 'never' },
    ...
    const handleUpdateRow = (updateRemoteModel) => {
        ...
        axios.put("api/DailyReport", reportModel)
    ...
    const handledownloadExcel = () => {
       const newData = data.map(row => {
        ...
        XLSX.utils.book_append_sheet(workBook, workSheet, "openingreport")
        let buf = XLSX.write(workBook, { bookType: "xlsx", type: "buffer" })
        XLSX.write(workBook, { bookType: "xlsx", type: "binary" })
        XLSX.writeFile(workBook, "openingreport.xlsx")
    ...
    const handleUpdateReport = (e) => {
        ...
        e.preventDefault();
        if (validate()) {
            axios.post("api/DailyReport/getUpdatedOpeningReport", searchModel).then(res => {
                setLoading(false)
                setData(res.data)
    ...
    useEffect(() => {
        axios.get("api/DailyReport/setDailyReportOpeningData")
